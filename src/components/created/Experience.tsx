  ...
  return (
    <div className="w-full flex flex-col justify-center align-middle lg:mt-36 mt-24 lg:px-36 md:px-24 px-8">
      <div className="grid max-lg:grid-cols-1 grid-cols-2 w-full gap-16">
        <div>
          <h1 className="text-4xl lg:text-5xl font-extrabold text-center">Experience</h1>
          {experience.map((exp) => {
            return (
              <>
        ...
        <div>
          <h1 className="text-4xl lg:text-5xl font-extrabold text-center">Skills</h1>
          <div className="masonry sm:masonry-sm md:masonry-md mt-6 text-center">
            {skills.map((skill)=>{
                return(
                    <>
